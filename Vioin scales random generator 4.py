...
#*******************************
#USER INFORMATION - currently only edited in source
...
(1) if i enter the name incorrectly, although it successfully initiates re-prompt,
but then when the name is entered correctly, it then produces a traceback "NoneType" error.

*NOTE TO SELF*
#if username is not None:
#suggestion from stackoverflow.com for NoneType error. but now im getting another one elsewhere...what's the issue?
